window.addEventListener("DOMContentLoaded", (event) => {
  gravFormPrefillerPlugin = (function () {
    ...
    function validationInit() {
      ...
      // Get translation for the active language
      gravFormPrefillerPlugin_translations = gravFormPrefillerPlugin.getTranslations();
      ...
      form.addEventListener("submit", function (event) {
        ...
        fileDivs.forEach(function (fileDiv) {
          ...
          if (required && uploads < 1) {
            allValid = false;
            showError(fileDiv, gravFormPrefillerPlugin_translations.PLUGIN_FORM_PREFILLER.VALIDATION.ERRORS.REQUIRED);
          }
          ...
          if (minNumber !== null && minNumber > 0 && uploads < minNumber) {
            allValid = false;
            const t = gravFormPrefillerPlugin_translations.PLUGIN_FORM_PREFILLER.VALIDATION.ERRORS.UPLOAD_MIN;
            ...
            if (maxNumber !== null && maxNumber > 0 && uploads > maxNumber) {
              allValid = false;
              const t = gravFormPrefillerPlugin_translations.PLUGIN_FORM_PREFILLER.VALIDATION.ERRORS.UPLOAD_MAX;
  ...
  gravFormPrefillerPlugin.validationInit();
